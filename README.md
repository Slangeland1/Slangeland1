...
## Work samples
I have a master's degree from the Quantitative Methods in the Social Sciences (QMSS) program, with a focus in Data Science, from Columbia University (2018).  Ever since, I've been a Data Scientist in industry, so all of my post-graduate work is protected by corporate NDAs and can't be displayed here.  However, I'm working on personal project on Large Language Models now, so stay tuned for a new repo, coming soon, if you'd like to see how I code, circa now 🚨.
